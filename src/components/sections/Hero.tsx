...
//           </h1>
//           <Paragraph className="mt-8">
//             At Ascendix IT, we specialize in delivering custom web apps, mobile apps, and AI/ML-powered solutions that help businesses innovate and scale faster. From sleek interfaces to intelligent automation, we bring your digital vision to life with cutting-edge technology and expert execution.
//           </Paragraph>
//           <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
//             <div className="flex sm:flex-row flex-col gap-5 w-full">
//               <form
